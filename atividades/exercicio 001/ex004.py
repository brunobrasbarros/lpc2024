print(("-"*20), "visualizador de numeros por extenso", (20*"-"))
...
"sessenta e cinco", "sessenta e seis", "sessenta e sete", 
"sessenta e oito", "sessenta e nove", "setenta", "setenta e um", 
...
"oitenta", "oitenta e um", "oitenta e dois", "oitenta e três", 
"oitenta e quatro", "oitenta e cinco", "oitenta e seis", "oitenta e sete", 
"oitenta e oito", "oitenta e nove", "noventa", "noventa e um", 
...
escolher_numero= int (input("escolha um numero de 1 a 99 "))

escolha = escolher_numero - 1
print(ListaDosNumeros[escolha])